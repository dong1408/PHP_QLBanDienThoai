...
<div id="main-content-wp" class="home-page clearfix">
    <div class="wp-inner">
        <div class="main-content fl-right">
            ...
            <div class="section" id="list-product-wp" style="padding: 15px 0px;">
                <!-- <div class="section-head">
                    <h3 class="section-title">Đeịn thoại</h3>
                </div> -->
                <?php
                ...
                ?>
                    <div class="section-detail">
                        <ul class="list-item clearfix">
                            ...
                            ?>
                                <li>
                                    <a href="?action=detail&id=<?php echo $product->getId() ?>" title="" class="thumb">
                                        <img src="<?php echo base_url("admin/{$product->getImageUrl()}") ?>">
                                    </a>
                                    <a href="?mod=product&id=<?php echo $product->getId() ?>" title="" class="product-name"><?php echo $product->getName() ?></a>
                                    <div class="price">
                                        <span class="new"><?php echo currency_format($product->getPrice()) ?></span>
                                        <span class="old"><?php echo currency_format($product->getPrice()) ?></span>
                                    </div>
                                    <div class="action clearfix">
                                        <a href="?action=detail&id=<?php echo $product->getId() ?>" class="detail-view">Xem chi tiết</a>
                                    </div>
                                </li>
                            <?php
                            }
            ...
            <div class="section">
                <nav aria-label="Page navigation example" style="display: flex; justify-content: center;">
                    <?php
                    if (!empty($q)) {
                        get_pagging($num_page, $page_current, "?q={$q}");
                    } else {
                        get_pagging($num_page, $page_current, "?");
                    }
                    ?>
