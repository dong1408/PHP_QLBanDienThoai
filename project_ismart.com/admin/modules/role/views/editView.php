                ...
                <div class="card-body">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nameRole" id="nameRole" value="<?php echo $role->getName() ?>">
                            <?php
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" type="text" name="description" id="description"><?php echo $role->getDescription() ?></textarea>
                            <?php
                                ...
                                <div class="card my-4 border">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            ?>
                                                <div class="col-md-3">
                                                    <input type="checkbox" class="permission" value="<?php echo $permission->getId() ?>" <?php if(is_array($listPermissionIdByRole) && in_array($permission->getId(), $listPermissionIdByRole)) echo "checked=checked" ?> name="list_permission_id[]" id="<?php echo $permission->getName() ?>">
